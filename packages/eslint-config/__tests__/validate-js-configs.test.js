...
describe('Validate JS configs', () => {
  it('Validate cyanic-eslint-config', async () => {
  ...
  it('Validate cyanic-eslint-config/es5', async () => {
  ...
  it('Validate cyanic-eslint-config/vue', async () => {
  ...
  it('Validate cyanic-eslint-config/essential', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/es5', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/react', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/vue', async () => {
  ...
  it('Validate cyanic-eslint-config/node', async () => {
