...
describe('Validate TS configs', () => {
  it('Validate cyanic-eslint-config/typescript', async () => {
  ...
  it('Validate cyanic-eslint-config/typescript/vue', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/typescript', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate cyanic-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate cyanic-eslint-config/typescript/node', async () => {
